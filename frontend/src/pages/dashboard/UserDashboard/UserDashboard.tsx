  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex flex-col">
      ...
      <div className="max-w-[1600px] mx-auto w-full border-x border-gray-300 shadow-xl bg-white rounded-2xl overflow-hidden">
        ...
        {/* Top Bar */}
        <div className="mx-4 mt-6 flex items-center gap-4 rounded-xl bg-gradient-to-r from-gray-800 to-gray-900 px-6 py-4 text-white shadow-lg transition-all duration-300 hover:shadow-2xl transform hover:scale-105">
          <button
